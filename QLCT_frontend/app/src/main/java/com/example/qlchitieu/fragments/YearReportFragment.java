...
public class YearReportFragment extends Fragment {
    ...
    TextView tv_year, tv_first, tv_last, tv_thu, tv_chi, tv_vay, tv_no, tv_thuno, tv_trano;
    LinearLayout lay_year, lay_header, lay_hide;
    ImageView im_hide;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_year_report, container, false);
    ...
    private void todo(){
        String data = tv_year.getText().toString() + "&" + matk;
        api.getYearReport(data).enqueue(new Callback<BaoCaoNgay>() {
            @Override
            public void onResponse(Call<BaoCaoNgay> call, Response<BaoCaoNgay> response) {
                ...
                if (response.code() == 500){
                    CustomToast.makeText(activity,"Lỗi hiển thị báo cáo", CustomToast.LENGTH_LONG,CustomToast.ERROR,true).show();
                }
            }
