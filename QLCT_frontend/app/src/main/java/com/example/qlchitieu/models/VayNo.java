...
public class VayNo {
    ...
    public VayNo(String ngay, String noidung, String loaiphatsinh, double sotien, String mota, int ma_taikhoan, String ngaytra, String hoten_vayno, String diachi_vayno, String sdt_vayno) {
        this.ngay = ngay;
